...
import com.example.android_task6_music_app.exoplayer.callbacks.MusicPlaybackPreparer
import com.example.android_task6_music_app.exoplayer.callbacks.MusicPlayerEventListener
import com.example.android_task6_music_app.exoplayer.callbacks.MusicPlayerNotificationListener
import com.example.android_task6_music_app.other.Constants.MEDIA_ROOT_ID
import com.example.android_task6_music_app.other.Constants.NETWORK_ERROR
...
class MusicService : MediaBrowserServiceCompat() {
    ...
    @Inject
    lateinit var rawMusicSource: RawMusicSource
    ...
    private inner class MusicQueueNavigator : TimelineQueueNavigator(mediaSession) {
        override fun getMediaDescription(player: Player, windowIndex: Int): MediaDescriptionCompat {
            return rawMusicSource.songs[windowIndex].description
        }
    }
